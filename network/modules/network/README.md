...
<!-- markdownlint-disable MD013 MD033 MD046 MD055 MD056 -->
...
- Virtual Private Cloud (VPC)
  - Enable DNS Hostname - A DNS hostname is a name that uniquely and absolutely names
    a computer; it's composed of a host name and a domain name. DNS servers resolve DNS
...
```hcl
module "network" {
  #source = "git::https://github.com/JDTayLabs/terraform-aws-network.git?ref=0.0.3"
