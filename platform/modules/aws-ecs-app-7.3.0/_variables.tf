...
variable "auth_oidc_issuer" {
  type        = string
  default     = ""
  description = "Issuer URL for OIDC authentication"
}

variable "auth_oidc_token_endpoint" {
  type        = string
  default     = ""
  description = "Token Endpoint URL for OIDC authentication"
}

variable "auth_oidc_user_info_endpoint" {
  type        = string
  default     = ""
  description = "User Info Endpoint URL for OIDC authentication"
}
